...
class RedactorTextPlugin(CMSPluginBase):
    model = Text
    ...
    def add_view(self, request, form_url='', extra_context=None):
        ...
        if getattr(self, "cms_plugin_instance", None):
            ...
            return super(RedactorTextPlugin, self).add_view(
    ...
    def save_model(self, request, obj, form, change):
        ...
        super(RedactorTextPlugin, self).save_model(request, obj, form, change)
...
plugin_pool.register_plugin(RedactorTextPlugin)
